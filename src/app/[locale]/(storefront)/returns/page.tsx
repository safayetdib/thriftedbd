    ...
    <main className="max-w-container mx-auto px-4 py-12 md:px-8 md:py-16">
      <div className="max-w-2xl">
        ...
        <div className="prose prose-sm text-ink-700 max-w-none space-y-4">
          ...
          <section>
            <h2 className="text-ink-900 mt-6 mb-2 text-lg font-bold">{t("policyTitle")}</h2>
            <p>{t("policyBody")}</p>
          </section>

          <section>
            <h2 className="text-ink-900 mt-6 mb-2 text-lg font-bold">{t("conditionTitle")}</h2>
          ...
          <section>
            <h2 className="text-ink-900 mt-6 mb-2 text-lg font-bold">{t("howTitle")}</h2>
